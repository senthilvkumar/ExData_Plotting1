...
par(mfrow=c(2,2))
plot(reqd$Date,reqd$Global_active_power,type="l",xlab="",ylab="Global Active Power")
plot(reqd$Date,reqd$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
legend("topright",lty=1,col=c("black","red","blue"),names(reqd)[7:9],bty="n")
plot(reqd$Date,reqd$Global_reactive_power,type="l",xlab="datetime",ylab=names(reqd)[4])
